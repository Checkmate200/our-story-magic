...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Anton&family=Playfair+Display:ital,wght@0,600;1,600&family=Inter:wght@400;500&family=JetBrains+Mono:wght@400&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
